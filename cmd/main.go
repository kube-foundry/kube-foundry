...
import (
	...
	"github.com/kube-foundry/kube-foundry/internal/controller"
...
func main() {
	...
	var agentImageClaudeCode string
	var agentImageCodex string
	var agentImageOpenCode string
	...
	flag.IntVar(&defaultTimeout, "default-timeout", 30, "Default timeout in minutes for sandbox pods")
	opts := zap.Options{
		Development: true,
	}
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "13401f2b.factory.io",
	...
	if err := (&controller.SoftwareTaskReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
		AgentImages: map[string]string{
			"claude-code": agentImageClaudeCode,
			"codex":       agentImageCodex,
			"open-code":   agentImageOpenCode,
		},
		DefaultCPU:            defaultCPU,
		DefaultMemory:         defaultMemory,
		DefaultTimeoutMinutes: int32(defaultTimeout),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "SoftwareTask")
		os.Exit(1)
	}
